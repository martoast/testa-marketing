<template>
    <div id="locations" class="bg-white py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-10 pt-16 lg:grid-cols-3">
            <div>
              <h2 class="text-3xl font-bold tracking-tight text-gray-900">Nuestras Ubicaciones</h2>
              <p class="mt-4 leading-7 text-gray-600">Contamos con presencia en varias ciudades para atenderte mejor.</p>
            </div>
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
              ...
              <div class="rounded-2xl bg-gray-50 p-10">
                ...
                <address class="mt-3 space-y-1 text-sm not-italic leading-6 text-gray-600">
                  <p>Calz. Gral. Mariano Escobedo,</p>
                  <p>476-piso 12, int. 1200-B,</p>
              ...
              <div class="rounded-2xl bg-gray-50 p-10">
                <h3 class="text-base font-semibold leading-7 text-gray-900">España, Barcelona</h3>
                <address class="mt-3 space-y-1 text-sm not-italic leading-6 text-gray-600">
                  <p>Av. Diagonal, 211 – PL.27 LOOM,</p>
                  <p>08018 - Barcelona</p>
                  <p>+34 670 35-3214</p>
                  <p><a href="mailto:josepmaria@testamarketing.com" class="text-primary">josepmaria@testamarketing.com</a></p>
                </address>
              </div>
              <div class="rounded-2xl bg-gray-50 p-10">
