<template>
    <footer id="footer" class="bg-white" aria-labelledby="footer-heading">
      ...
      <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-4">
            <img class="h-28" src="/TESTA_LOGO CENTRAL COMPLETO_COLOR.svg" alt="Company name" />
  ...
  contact: [
    ...
    { name: 'Guadalajara', href: '/#locations' },
    { name: 'Tijuana B.C.', href: '/#locations' },
    { name: 'España, Barcelona', href: '/#locations' },
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/TestaMarketing',
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/testamarketing/',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/x/migrate?tok=7b2265223a222f54657374614d61726b6574696e672f3f707265666574636854696d657374616d703d31373235333230343834303538222c2274223a313732353332303438347d6a6fcc36b8f31a13f8819c92addd9feb',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/testa-marketing/',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
